...
from src.infrastructure.driving.api.v1.schemas.orders import OrderItem
from src.infrastructure.driving.api.v1.routes.orders import router as orders_router
from src.infrastructure.driving.api.v1.routes.auth import router as auth_router
